...
const MosaicView = () => {
  ...
  return (
    <div className="flex flex-col items-center max-h-[calc(screen_dvh-65px)] overflow-hidden pb-20 px-6 sm:px-10 md:px-20 bg-green-300">
      <div className="sticky top-0 z-10 w-full bg-green-300 py-4 px-6 text-center">
        <SectionHead
          title="New Arrivals."
          description="Check out our new arrivals."
        />
      </div>
      <div className="columns-4 gap-2 p-4">
